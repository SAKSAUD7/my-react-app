...
import { ArrowLeftIcon, DocumentArrowUpIcon, PhotoIcon, XMarkIcon } from '@heroicons/react/24/outline';
...
export default function PdfToJpg() {
  ...
  const handleConvert = async () => {
    ...
    const loadingToast = toast.loading('Converting your PDF to images...');

    try {
      const response = await uploadFile('/api/pdf/convert-to-jpg', files[0]);
      downloadBlob(response, files[0].name.replace('.pdf', '.jpg'));
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-lg text-gray-600">
              Convert your PDF pages into high-quality JPG images for easy sharing and viewing.
            </p>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3">
              <div className="rounded-2xl bg-gray-50 p-6">
                <h3 className="text-lg font-semibold text-gray-900">High Quality</h3>
                <p className="mt-2 text-sm text-gray-600">
                  Convert PDF pages to high-resolution JPG images with crisp details.
                </p>
              </div>
              <div className="rounded-2xl bg-gray-50 p-6">
                <h3 className="text-lg font-semibold text-gray-900">All Pages</h3>
                <p className="mt-2 text-sm text-gray-600">
                  Each page of your PDF is converted to a separate JPG image file.
                </p>
              </div>
              <div className="rounded-2xl bg-gray-50 p-6">
                <h3 className="text-lg font-semibold text-gray-900">Easy Sharing</h3>
                <p className="mt-2 text-sm text-gray-600">
                  Share your PDF content as images on social media and websites.
                </p>
              </div>
            </div>
          </div>
