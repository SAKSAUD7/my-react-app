...
export default function PdfToExcel() {
  ...
  const handleConvert = async () => {
    ...
    try {
      const response = await uploadFile('/api/pdf/convert-to-excel', files[0]);
      downloadBlob(response, files[0].name.replace('.pdf', '.xlsx'));
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h1 className="text-2xl font-semibold text-gray-900">Convert PDF to Excel</h1>
              <p className="mt-2 text-sm text-gray-500">
                Extract tables and data from your PDF documents into editable Excel spreadsheets.
              </p>
              ...
              <div className="mt-6">
                <h3 className="text-sm font-medium text-gray-900">How to convert PDF to Excel:</h3>
                <ol className="mt-2 list-decimal list-inside text-sm text-gray-500 space-y-2">
                  ...
                  <li>Your Excel spreadsheet will be downloaded automatically</li>
                </ol>
              </div>
              ...
              <div className="mt-6">
                ...
                <ul className="mt-2 list-disc list-inside text-sm text-gray-500 space-y-2">
                  <li>Extracts tables and data accurately</li>
                  <li>Preserves formatting and structure</li>
                  <li>Creates editable spreadsheets</li>
              ...
              <div className="mt-6">
                ...
                <ul className="mt-2 list-disc list-inside text-sm text-gray-500 space-y-2">
                  ...
                  <li>Any PDF containing tabular data</li>
                </ul>
              </div>
            </div>
          </div>
